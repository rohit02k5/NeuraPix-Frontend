...
<div>
    <h1 className="font-extrabold text-[#222328] dark:text-white text-[32px]">THE GALLERY</h1>
<p className="mt-2 text-[#666e75] dark:text-white text-[18px] max-w[500px]">Explore the stunning images generated by DALL-E through prompts</p>
</div>
<div className="mt-16">
